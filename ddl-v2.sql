-- ddl-v2.sql
-- Archivo de Definición de Datos (DDL) Idempotente para el Proyecto Distribuido
-- Se debe ejecutar en cada uno de los 4 nodos (Matriz y Sucursales A, B, C)
-- Cátedra: Procesamiento de Datos - UCOM 2026
-- Docente: Ing. David Britez

-- Crear la tabla local de ventas en el nodo si no existe
